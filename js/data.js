...
const THEMES = [
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        backgroundImage: "images/tea.jpeg", // e.g. "assets/backgrounds/tea.jpg"
      },
      {
        id: "soda",
        type: "textarea",
        ...
        backgroundImage: "images/gaz.jpeg", // e.g. "assets/backgrounds/soda.jpg"
      },
      {
        id: "desserts",
        type: "textarea",
      ...
      },
      {
        ...
        backgroundImage: "images/chocolate.jpeg", // e.g. "assets/backgrounds/chocolate.jpg"
      },
      {
        id: "fruits",
        type: "textarea",
        prompt: { ru: "Какие фрукты ты любишь?", uz: "Qanday mevalarni yoqtirasan?", en: "What fruits do you like?" },
        backgroundImage: "images/fruits.jpeg", // e.g. "assets/backgrounds/fruits.jpg"
      },
      {
        id: "berries",
        type: "textarea",
        prompt: { ru: "Какие ягоды тебе нравятся?", uz: "Qanday rezavorlar senga yoqadi?", en: "What berries do you like?" },
        backgroundImage: "images/yagoda.jpeg", // e.g. "assets/backgrounds/berries.jpg"
      },
    ],
  },

  {
    ...
    backgroundImage: "images/walk.jpeg",
    themeImage: null,
    questions: [
      {
        id: "likes_walking",
...

  {
    ...
    backgroundImage: "images/walk1.jpeg",
    themeImage: null,
    questions: [
...

  {
    ...
    backgroundImage: "images/support.jpeg",
    themeImage: null,
    questions: [
      {
        id: "stress_signs",
